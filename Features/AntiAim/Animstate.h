...
public: // fake state
	...
	C_AnimState* m_fake_state = nullptr;
...
public: // real state
	...
	C_AnimState* m_real_state = nullptr;
...
public:
	...
	Vector m_current_real_angle = Vector(0.f, 0.f, 0.f);
	Vector m_current_fake_angle = Vector(0.f, 0.f, 0.f);
...
extern c_animations Animations;
