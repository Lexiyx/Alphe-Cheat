...
public:
	...
	{
		auto clientState = *reinterpret_cast<uintptr_t*>(uintptr_t(GetModuleHandle("engine.dll")) + 0x58EFE4);
		auto intnetchan = *reinterpret_cast<uintptr_t*>(clientState + 0x9C);
		NetChannel* netchan = reinterpret_cast<NetChannel*>(intnetchan);
		return  netchan;
	}*/ //i found a way better solution
	const matrix3x4& MatrixWorldToScreenMatrix()
	{
